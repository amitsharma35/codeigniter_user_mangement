          ...
          <div class="col-md-8">
            <h3>Personal Information:</h3>
					...
					<div class="form-group has-feedback clear-both">
		              ...
		              <input type="text" id="address" name="address" value="<?php echo (isset($user_data[0]->Address)?$user_data[0]->Address:'');?>" required="required" class="form-control" placeholder="Email">
		              <span class="glyphicon glyphicon-user form-control-feedback"></span>
		            </div>
